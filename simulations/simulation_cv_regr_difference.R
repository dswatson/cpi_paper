...
# Registry ----------------------------------------------------------------
reg_name <- "cpi_sim_cv_regr_difference"
...
saveRDS(res, "simulation_cv_regr_difference.Rds")
...
lapply(unique(res$measure), function(m) {
  ...
  ggsave(paste0("cv_regr_difference_CPI_", m, ".pdf"), width = 10, height = 5)
  #ggsave(paste0("cv_regr_difference_CPI_", m, ".png"), width = 10, height = 5, dpi = 300)
})
...
lapply(unique(res$measure), function(m) {
  ...
  ggsave(paste0("cv_regr_difference_tstat_", m, ".pdf"), width = 10, height = 5)
})
...
lapply(unique(res$measure), function(m) {
  ...
  ggsave(paste0("cv_regr_difference_power_", m, ".pdf"), width = 10, height = 5)
})
